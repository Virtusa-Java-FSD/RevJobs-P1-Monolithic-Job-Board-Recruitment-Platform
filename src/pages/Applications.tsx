  ...
  const fetchApplications = async () => {
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        // Fallback: Check localStorage for applied jobs
        console.log('API returned empty, checking localStorage...');
        const localApps = JSON.parse(localStorage.getItem(`appliedJobs_${user.email}`) || '[]');
        console.log('LocalStorage applications:', localApps);
